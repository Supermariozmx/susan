...
//获取指定用户
export const reqOneUser = (userId) => ajax(BASE + '/personal/user', { userId })
...
searchType: 搜索的类型, productName/productDesc
*/
export const reqSearchOrders = ({ pageNum, pageSize, searchName, searchType }) => ajax(BASE + '/manage/order/search', {
  pageNum,
  pageSize,
  [searchType]: searchName,
})
...
// 更新订单的状态
export const updateOderStatus = (orderId, status) => ajax(BASE + '/manage/order/updateStatus', { orderId, status }, 'POST')
